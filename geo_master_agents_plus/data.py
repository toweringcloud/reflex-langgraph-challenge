...
# GEO_ALIASES의 역매핑 (표준 이름에서 다양한 표현으로)
GEO_ALIASES_REVERSE = {
...
# 언어 코드 매핑 (언어 이름에서 ISO 639-1 코드로)
LANGUAGE = {
    "English": {"code": "en", "local": "English"},
    "Chinese": {"code": "zh", "local": "中文"},
    "Hindi": {"code": "hi", "local": "हिन्दी"},
    "Spanish": {"code": "es", "local": "Español"},
    "Arabic": {"code": "ar", "local": "العربية"},
    "French": {"code": "fr", "local": "Français"},
    "Bengali": {"code": "bn", "local": "বাংলা"},
    "Portuguese": {"code": "pt", "local": "Português"},
    "Indonesian": {"code": "id", "local": "Bahasa Indonesia"},
    "Urdu": {"code": "ur", "local": "اُردُو"},
    "Russian": {"code": "ru", "local": "Русский"},
    "German": {"code": "de", "local": "Deutsch"},
    "Japanese": {"code": "ja", "local": "日本語"},
    "Vietnamese": {"code": "vi", "local": "Tiếng Việt"},
    "Turkish": {"code": "tr", "local": "Türkçe"},
    "Korean": {"code": "ko", "local": "한국어"},
    "Italian": {"code": "it", "local": "Italiano"},
    "Thai": {"code": "th", "local": "ไทย"},
    "Dutch": {"code": "nl", "local": "Nederlands"},
    "Greek": {"code": "el", "local": "Ελληνικά"},
    "Swedish": {"code": "sv", "local": "Svenska"},
    "Danish": {"code": "da", "local": "Dansk"},
    "Norwegian": {"code": "no", "local": "Norsk"},
    "Finnish": {"code": "fi", "local": "Suomi"},
}
